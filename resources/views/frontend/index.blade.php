      ...
      <div class="row">
        <div class="col-sm-6 col-md-4 col-lg-3">
          <div class="box">
            <a href="">
              <div class="img-box">
                <img src="{{url('frontend/images/p1.png')}}" alt="">
              </div>
              <div class="detail-box">
                <h6>
                  Ring
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
          <div class="box">
            <a href="">
              <div class="img-box">
                <img src="{{url('frontend/images/p2.png')}}" alt="">
              </div>
              <div class="detail-box">
                <h6>
                  Watch
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
          <div class="box">
            <a href="">
              <div class="img-box">
                <img src="{{url('frontend/images/p3.png')}}" alt="">
              </div>
              <div class="detail-box">
                <h6>
                  Teddy Bear
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
          <div class="box">
            <a href="">
              <div class="img-box">
                <img src="{{url('frontend/images/p4.png')}}"  alt="">
              </div>
              <div class="detail-box">
                <h6>
                  Flower Bouquet
    ...
    <div class="box">
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-6">
            <div class="img-box">
              <img src="{{url('frontend/images/saving-im')}} g.png" alt="">
            </div>
          </div>
          <div class="col-lg-6">
            <div class="detail-box">
        ...
        <div class="row">
          <div class="col-md-5">
            <div class="img_container">
              <div class="img-box">
                <img src="{{url('frontend/images/gifts.png')}} " alt="">
              </div>
            </div>
          </div>
          <div class="col-md-7">
